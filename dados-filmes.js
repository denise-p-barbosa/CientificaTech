...
const catalogoCuradoria = [
    {
        ...
        titulo: "Interestelar",
        imagem: "https://image.tmdb.org/t/p/w300/gEU2QniL6C8zt75201rMAk810nC.jpg",
        estrelas: "★★★★★",
        autor: "Marcos (Eng. Física)",
        
        // Escreva o texto abaixo entre as aspas. Pode ser longo.
        depoimento: "Mano do céu, eu não consigo explicar o que senti vendo isso no cinema. A trilha do Hans Zimmer na cena da acoplagem é a coisa mais tensa que já vi na vida. Fora a representação do Buraco Negro que é cientificamente precisa (o Kip Thorne ajudou!). O final me deixou encarando a parede por 3 horas pensando na vida. Obrigatório pra quem faz nosso curso."
    },
